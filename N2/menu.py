        ...
        if opcao == 0:
            ...
            if tipo == 1:
                ...
                try:
                    ...
                    print("Erro em salvar dado deletado", error)
                mongo.delete("email", valor)
        elif opcao == 4:
            print(" 1. Nome; \n 2. CPF; \n 3. E-mail;")
            tipo = int(input("Informe em qual coluna sera o filtro: "))
            pesquisa = input("Informe uma informacao da pessoa a ser pesquisada: ")
            if tipo == 1:
                mongo = ConexaoMongo()
...
# Remoção Logica
# Para fazer a Remocao Logica, utilizei um arquivo "dados_deletados"
# para salvar os dados das pessoas que nao iriam mais ser utilizadas no banco de dados
